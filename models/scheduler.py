...
class TaskSched(Base):
    ...
    list_id = Column('list_id', String(11), nullable=False, index=True)
    ...
    exec_user = Column('exec_user', String(80))
...
class TaskLog(Base):
    ...
    log_key = Column('log_key', String(35), index=True)
    task_level = Column('task_level', Integer)
...
class ExecuteUser(Base):
    ...
    exec_user = Column('exec_user', String(50), default='root')
